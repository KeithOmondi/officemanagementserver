// src/features/tasks/task.controller.ts
...
export const taskController = {
    ...
    getAllProjects: asyncHandler(async (_req: Request, res: Response) => {
        const projects = await TaskService.findAllProjects();
    ...
    getProjectById: asyncHandler(async (req: Request, res: Response) => {
        ...
        const project = await TaskService.findProjectById(result.data.params.id);
        if (!project) {
    ...
    deleteProject: asyncHandler(async (req: Request, res: Response) => {
        ...
        await TaskService.deleteProject(result.data.params.id);
    ...
    getStandaloneTasks: asyncHandler(async (_req: Request, res: Response) => {
        const tasks = await TaskService.findStandaloneTasks();
    ...
    getTaskById: asyncHandler(async (req: Request, res: Response) => {
        ...
        const task = await TaskService.findTaskById(result.data.params.id);
        if (!task) {
    ...
    deleteTask: asyncHandler(async (req: Request, res: Response) => {
        ...
        await TaskService.deleteTask(result.data.params.id);
