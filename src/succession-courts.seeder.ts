...
export function getSuccessionCourtSeedData(): SeedCourt[] {
  return [
    ...
    // ─── Category D ──────────────────────────────────────────────────
    // Station D from PDF (Pages 4-5)
    // First set from Page 4
    {
    ...
    // Continue from Page 5 - Bomet Law Courts
    {
      name: "Bomet Law Courts",
      station: "Bomet Law Courts",
      category: "D",
    },
    {
      name: "Nyeri Law Courts",
      station: "Nyeri Law Courts",
      category: "D",
    },
    {
      name: "Mumias Law Courts",
      station: "Mumias Law Courts",
      category: "D",
    },
    {
      name: "Butali Law Courts",
      station: "Butali Law Courts",
      category: "D",
    },
    {
      name: "Kericho Law Courts",
      station: "Kericho Law Courts",
      category: "D",
    },
    {
      name: "Yala Law Courts",
      station: "Yala Law Courts",
      category: "D",
    },
    {
      name: "Eldoret Law Courts",
      station: "Eldoret Law Courts",
      category: "D",
    },
    {
      name: "Winam Law Courts",
      station: "Winam Law Courts",
      category: "D",
    },
    {
      name: "Maseno Law Courts",
      station: "Maseno Law Courts",
      category: "D",
    },
    {
      name: "Nyando Law Courts",
      station: "Nyando Law Courts",
      category: "D",
    },
    {
      name: "Tamu Law Courts",
      station: "Tamu Law Courts",
      category: "D",
    },
    {
      name: "Homa-bay Law Courts",
      station: "Homa-bay Law Courts",
      category: "D",
    },
    {
      name: "Ndhiwa Law Courts",
      station: "Ndhiwa Law Courts",
      category: "D",
    },
    {
      name: "Migori Law Courts",
      station: "Migori Law Courts",
      category: "D",
    },
    {
      name: "Kisii Law Courts",
      station: "Kisii Law Courts",
      category: "D",
    },
    {
      name: "Keroka Law Courts",
      station: "Keroka Law Courts",
      category: "D",
    },
    {
      name: "Ogembo Law Courts",
      station: "Ogembo Law Courts",
      category: "D",
    },
    {
      name: "Butere Law Courts",
      station: "Butere Law Courts",
      category: "D",
    },
    {
      name: "Kerugoya Law Courts",
      station: "Kerugoya Law Courts",
      category: "D",
    },
    {
      name: "Baricho Law Courts",
      station: "Baricho Law Courts",
      category: "D",
    },
    {
      name: "Gichugu Law Courts",
      station: "Gichugu Law Courts",
      category: "D",
    },
    {
      name: "Wang'uru Law Courts",
      station: "Wang'uru Law Courts",
      category: "D",
    },
    {
      name: "Kandara Law Courts",
      station: "Kandara Law Courts",
      category: "D",
    },
    {
      name: "Siaya Law Courts",
      station: "Siaya Law Courts",
      category: "D",
    },
    {
      name: "Bondo Law Courts",
      station: "Bondo Law Courts",
      category: "D",
    },
    {
      name: "Kenol Law Court",
      station: "Kenol Law Court",
      category: "D",
    },
    {
      name: "Vihiga Law Courts",
      station: "Vihiga Law Courts",
      category: "D",
    },
  ];
}
...
export class SuccessionCourtSeeder {
  ...
  static async getValidUserId(providedUserId?: string): Promise<string> {
    ...
    if (providedUserId) {
      ...
      console.warn(
        `⚠️  Provided user ID "${providedUserId}" not found or inactive. Searching for alternative...`,
      );
    }
  ...
  static async clear(): Promise<{ deleted: number }> {
    const { rows } = await pool.query(
      `DELETE FROM succession_courts RETURNING id`,
    );
  ...
  static async count(): Promise<number> {
    const { rows } = await pool.query(
      `SELECT COUNT(*) as count FROM succession_courts`,
    );
  ...
  static validate(): { valid: boolean; errors: string[] } {
    ...
    courts.forEach((court, index) => {
      ...
      if (!["A", "B", "C", "D"].includes(court.category)) {
        errors.push(
          `Invalid category at index ${index}: Must be A, B, C, or D`,
        );
      }
    });
  ...
  (async () => {
    ...
    try {
      ...
      try {
        ...
        console.log(
          "      npx ts-node src/features/succession-courts/succession-courts.seeder.ts <user-uuid>",
        );
        process.exit(1);
      }
      ...
      if (shouldClear) {
        console.log(
          "⚠️  WARNING: You are about to delete ALL succession courts!",
        );
      ...
      if (isDryRun) {
        ...
        console.log(
          `   Would insert ${getSuccessionCourtSeedData().length} courts\n`,
        );
        const result = await SuccessionCourtSeeder.seed(userId, {
          dryRun: true,
          force: isForce,
        });
