...
export const createServiceWeekSchema = z.object({
  body: z.object({
    ...
    confirmed_designation: z.string().optional(),
    confirmed_date: z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'Invalid date format').optional(),
    approved_by: z.string().optional(),
    approved_designation: z.string().optional(),
    approved_date: z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'Invalid date format').optional(),
