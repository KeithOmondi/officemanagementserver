...
export interface Passenger {
  id?: string; // Optional - may be auto-generated by backend
  name: string;
  judge_name?: string | null;
  pj_number?: string | null;
  time_of_travel?: string | null; // HH:MM format - individual departure time
  return_time?: string | null; // HH:MM format - individual return time
}
...
export interface Ticket {
  ...
  // ─── Passengers ──────────────────────────────────────────────────────────
  passengers?: Passenger[]; // Multi-passenger support
